...
const element = document.getElementById("tombolNyalaKamera");
element.addEventListener("click", function() {
  startMedia();
});

const element2 = document.getElementById("tombolMatiKamera");
...
const element3 = document.getElementById("tutupKameraModal");
element3.addEventListener("click", function() {
  videoPlayer.srcObject.getVideoTracks().forEach(track => {
    track.stop();
  });

  var canvasElement2 = document.querySelector("#canvas");
...
const element4 = document.getElementById("simpan-foto-btn");
element4.addEventListener("click", event => {
  let picture = canvasElement.toDataURL();
const foto_pengguna = document.getElementById("foto-pengguna");
foto_pengguna.src = picture;

const foto_url = document.getElementById("foto-url");
foto_url.value = picture;
});
